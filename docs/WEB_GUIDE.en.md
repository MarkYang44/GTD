...
**Race Strategy** accepts race duration, average lap time and fuel per lap. Blank fields use 30 minutes, 120 sec/lap and 3 L/lap; invalid nonempty input requires correction.
