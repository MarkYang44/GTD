...
class LmuToolsBrowserTests(BrowserReliabilityTests):
    ...
    def test_lmu_search_filters_and_reset(self):
        ...
        expect(self.page.locator('#fuji .recommendation:not([hidden])')).to_have_count(4)
        ...
        expect(self.page.locator('.circuit-card:visible')).to_have_count(18)
    ...
    def test_lmu_mobile_compare_language_focus_and_no_javascript(self):
        ...
        expect(page.locator('.circuit-card:visible')).to_have_count(18)
